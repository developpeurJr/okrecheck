...
export default function Confidentialite() {
  return (
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <h2 style={{ marginTop: "1.5rem" }}>2. Utilisation de Vercel Analytics / Use of Vercel Analytics</h2>
      <p>
        Ce site utilise **Vercel Analytics** pour collecter des données d&apos;analyse agrégées et anonymes. Ces données aident à améliorer les performances du site et à mieux comprendre comment il est utilisé. Aucune information personnelle n&apos;est collectée.
        <br />
        This site uses **Vercel Analytics** to collect aggregated, anonymous analytics data. This data helps improve the site&apos;s performance and better understand how it is used. No personal information is collected.
      </p>

      <h2 style={{ marginTop: "1.5rem" }}>3. Pas de cookies / No cookies</h2>
      <p>
      ...
      <h2 style={{ marginTop: "1.5rem" }}>4. Sécurité / Security</h2>
      <p>
      ...
      <h2 style={{ marginTop: "1.5rem" }}>5. Contact / Contact</h2>
      <p>
